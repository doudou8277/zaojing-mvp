...
export const DIRECTORS: Director[] = [
  {
    ...
    titleWeight: 700,
    promptCore: 'Miyazaki style, dreamy sky, lush nature, young girl, healing, Studio Ghibli, hand-drawn aesthetic, watercolor textures, golden hour',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'high', contrast: 'medium', compositionType: 'symmetric', lightingType: 'natural', scale: 'monumental', pace: 'dynamic', texture: 'smooth' }
  },
  {
    id: 'wkw',
    name: '王家卫',
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 600,
    promptCore: 'Wong Kar-wai style, neon green, intimate lighting, lonely urban night, single line monologue, motion blur, rain-soaked streets',
  ...
  },
  {
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 600,
    promptCore: 'Koreeda style, soft daylight, family life, gentle moments, subtle emotions, warm tones, natural setting',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'medium', contrast: 'low', compositionType: 'centered', lightingType: 'natural', scale: 'intimate', pace: 'static', texture: 'smooth' }
  },
  {
    id: 'wes',
    name: '韦斯·安德森',
    ...
    titleWeight: 700,
    promptCore: 'Wes Anderson style, perfect symmetry, pastel palette, quirky composition, flat plane, centered framing',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'high', contrast: 'medium', compositionType: 'symmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' }
  },
  {
    id: 'nolan',
    name: '诺兰',
    ...
    fontFamily: '"Noto Sans SC", sans-serif',
    titleWeight: 700,
    promptCore: 'Christopher Nolan style, cold palette, monumental, philosophical, time distortion, IMAX aesthetic, epic scale',
  ...
  },
  {
    ...
    fontFamily: '"Noto Sans SC", sans-serif',
    titleWeight: 900,
    promptCore: 'Stephen Chow style, exaggerated comic, Hong Kong neon, dramatic, humorous, vibrant colors, mo lei tau comedy',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'high', contrast: 'high', compositionType: 'asymmetric', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'grainy' }
  },
  {
    id: 'jia',
    name: '贾樟柯',
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 600,
    promptCore: 'Jia Zhangke style, muted earth tones, faded desaturated colors, long take static wide shots, observational distance, natural available light, demolition sites and transitional spaces, documentary realism, social transformation landscape',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'low', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'grainy' }
  },
  {
    id: 'lee',
    name: '李安',
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 700,
    promptCore: 'Ang Lee style, classical balanced composition, fluid camera movement, painterly naturalistic lighting, Eastern aesthetic ink-wash atmosphere, lush greens and golds, emotional restraint, cinematic elegance',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'medium', contrast: 'medium', compositionType: 'symmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' }
  },
  {
    id: 'kurosawa',
    name: '黑泽明',
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 900,
    promptCore: 'Akira Kurosawa style, bold primary colors, dynamic geometric blocking of multiple figures, telephoto compression, weather as character rain wind fog snow, dramatic natural lighting, epic humanistic scale, movement-based composition',
    ...
    styleDNA: { colorTemperature: 'warm', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'monumental', pace: 'dynamic', texture: 'grainy' }
  },
  {
    id: 'coppola',
    name: '索菲亚·科波拉',
    ...
    fontFamily: '"Noto Serif SC", serif',
    titleWeight: 400,
    promptCore: 'Sofia Coppola style, soft pastel palette, muted pinks and blues, abundant negative space, natural window light, golden hour glow, isolated figures in vast spaces, hotel liminal spaces, dreamy overexposed highlights, intimate loneliness',
    negativePrompt: 'high contrast, dramatic lighting, action, crowded scenes, sharp edges, saturated colors, dark mood',
    quotes: [
      '在陌生的城市里，孤独是一种奢侈。',
      '有些话，只有在黑暗中才说得出口。',
      '我们都在寻找连接，却总是擦肩而过。',
    ...
    styleDNA: { colorTemperature: 'cool', saturation: 'low', contrast: 'low', compositionType: 'asymmetric', lightingType: 'natural', scale: 'intimate', pace: 'static', texture: 'smooth' }
  },
  {
    id: 'chazelle',
    name: '查泽雷',
    ...
    fontFamily: '"Noto Sans SC", sans-serif',
    titleWeight: 700,
    promptCore: 'Damien Chazelle style, vibrant primary colors, dreamy purple and sunset orange, dynamic whip pans and long takes, theatrical stage lighting, colored gel lighting, golden hour backlight, musical staging composition, jazz imagery',
    ...
    styleDNA: { colorTemperature: 'cool', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'smooth' }
  },
  {
    id: 'tarantino',
    name: '昆汀',
    ...
    fontFamily: '"Noto Sans SC", sans-serif',
    titleWeight: 900,
    promptCore: 'Quentin Tarantino style, bold saturated colors, blood red and warm yellow, dynamic low-angle shots, trunk shot perspective, extreme close-ups, retro grindhouse aesthetic, 70mm wide frame, stylized violence, pop culture references',
...
export const POSTER_TEMPLATES: PosterTemplate[] = [
  // --- 电影场景 ---
  { id: 'tpl-cinema-01', name: '深夜独行', emoji: '🌃', text: '深夜加班后走出写字楼，抬头看见月亮', directorId: 'wkw', format: 'vertical', moodTagId: 'overtime', category: 'cinema', source: 'preset' },
  { id: 'tpl-cinema-02', name: '雨中漫步', emoji: '🌧️', text: '在异乡的公交车上，窗外下着雨，耳机里是老歌', directorId: 'wkw', format: 'vertical', moodTagId: 'lonely', category: 'cinema', source: 'preset' },
  { id: 'tpl-cinema-03', name: '夏日告别', emoji: '🌅', text: '毕业最后一晚的宿舍，空荡荡的床铺和关不掉的灯', directorId: 'miyazaki', format: 'vertical', moodTagId: 'relief', category: 'cinema', source: 'preset' },
  { id: 'tpl-cinema-04', name: '星际远航', emoji: '🚀', text: '在浩瀚星空中漂流，地球只是一颗蓝色的弹珠', directorId: 'nolan', format: 'horizontal', category: 'cinema', source: 'preset' },
  { id: 'tpl-cinema-05', name: '暗夜追踪', emoji: '🔦', text: '霓虹灯下的追逐，每一步都在与时间赛跑', directorId: 'nolan', format: 'vertical', category: 'cinema', source: 'preset' },
  // --- 情绪表达 ---
  { id: 'tpl-emo-01', name: '未说出口的话', emoji: '💬', text: '和好朋友大吵一架后的后悔，想道歉又开不了口', directorId: 'koreeda', format: 'vertical', moodTagId: 'ex', category: 'emotion', source: 'preset' },
  { id: 'tpl-emo-02', name: '暗恋心事', emoji: '💌', text: '每次遇见你，心跳都会漏一拍，但假装若无其事', directorId: 'wkw', format: 'square', moodTagId: 'crush', category: 'emotion', source: 'preset' },
  { id: 'tpl-emo-03', name: '想家的夜', emoji: '🏠', text: '电话那头妈妈说天冷加衣，这头我已泪流满面', directorId: 'miyazaki', format: 'vertical', moodTagId: 'homesick', category: 'emotion', source: 'preset' },
  { id: 'tpl-emo-04', name: '释然时刻', emoji: '☀️', text: '终于放下了那段执念，阳光照进窗台，一切重新开始', directorId: 'chazelle', format: 'vertical', moodTagId: 'relief', category: 'emotion', source: 'preset' },
  { id: 'tpl-emo-05', name: '暴富梦', emoji: '💰', text: '梦想有一天不用看闹钟，阳光和自由都是我的', directorId: 'wes', format: 'square', moodTagId: 'rich', category: 'emotion', source: 'preset' },
  { id: 'tpl-emo-06', name: '自由飞翔', emoji: '🕊️', text: '站在山顶，风穿过指尖，全世界都在脚下', directorId: 'miyazaki', format: 'horizontal', moodTagId: 'free', category: 'emotion', source: 'preset' },
  // --- 节日场景 ---
  { id: 'tpl-fest-01', name: '新年愿望', emoji: '🎆', text: '新年的第一束烟花，许下关于你的愿望', directorId: 'chazelle', format: 'vertical', category: 'festival', source: 'preset' },
  { id: 'tpl-fest-02', name: '中秋月圆', emoji: '🌕', text: '月圆之夜，千里之外的你也在这片月光下吧', directorId: 'lee', format: 'square', moodTagId: 'homesick', category: 'festival', source: 'preset' },
  { id: 'tpl-fest-03', name: '圣诞夜', emoji: '🎄', text: '街角的圣诞树亮了，一个人走过也觉得温暖', directorId: 'wes', format: 'vertical', category: 'festival', source: 'preset' },
  { id: 'tpl-fest-04', name: '毕业季', emoji: '🎓', text: '散伙饭上没人哭，出了门才发现真的散了', directorId: 'koreeda', format: 'vertical', moodTagId: 'relief', category: 'festival', source: 'preset' },
  // --- 社交场景 ---
  { id: 'tpl-soc-01', name: '微博金句', emoji: '📱', text: '生活不会因为你软弱而对你温柔', directorId: 'wkw', format: 'weibo', category: 'social', source: 'preset' },
  { id: 'tpl-soc-02', name: '小红书种草', emoji: '📕', text: '周末去了一家藏在巷子里的咖啡馆，治愈了一整周', directorId: 'wes', format: 'xhs', category: 'social', source: 'preset' },
  { id: 'tpl-soc-03', name: '公众号封面', emoji: '📝', text: '当 AI 遇见电影：一场关于情绪的视觉实验', directorId: 'nolan', format: 'wechat', category: 'social', source: 'preset' },
  { id: 'tpl-soc-04', name: '抖音封面', emoji: '🎬', text: '这条视频太治愈了，看完整个人都好了', directorId: 'miyazaki', format: 'douyin', moodTagId: 'healing', category: 'social', source: 'preset' },
  { id: 'tpl-soc-05', name: '九宫格日记', emoji: '🖼️', text: '这一周的九个瞬间，记录生活的小确幸', directorId: 'wes', format: 'grid9', category: 'social', source: 'preset' },
  // --- 治愈系列 ---
  { id: 'tpl-heal-01', name: '晨光微暖', emoji: '🌅', text: '早起看到的第一个日出，感觉一切都会好起来', directorId: 'miyazaki', format: 'vertical', moodTagId: 'healing', category: 'emotion', source: 'preset' },
  { id: 'tpl-heal-02', name: '雨后初晴', emoji: '🌈', text: '暴雨后的彩虹，是大自然给勇敢者的奖赏', directorId: 'chazelle', format: 'horizontal', moodTagId: 'healing', category: 'emotion', source: 'preset' },
];
...
export const EMOTION_SPECTRUM: Record<string, EmotionSpectrumEntry> = {
  '孤独': { color: '#6b7c93', gradient: 'linear-gradient(90deg, #2c3e50, #6b7c93, #95a5a6)', keywords: ['空旷', '独白', '寂静'] },
  '忧伤': { color: '#5d6d7e', gradient: 'linear-gradient(90deg, #34495e, #5d6d7e, #85929e)', keywords: ['雨夜', '失落', '沉默'] },
  '思念': { color: '#d4b88a', gradient: 'linear-gradient(90deg, #b8860b, #d4b88a, #e8c89c)', keywords: ['远方', '故乡', '灯火'] },
  '温暖': { color: '#e8a87c', gradient: 'linear-gradient(90deg, #d68a5c, #e8a87c, #f4c4a0)', keywords: ['阳光', '温柔', '回忆'] },
  '治愈': { color: '#7fc4ab', gradient: 'linear-gradient(90deg, #5a9e8a, #7fc4ab, #a8d8c8)', keywords: ['新生', '微风', '绿意'] },
  '暧昧': { color: '#c39bd3', gradient: 'linear-gradient(90deg, #8e44ad, #c39bd3, #d7bde2)', keywords: ['霓虹', '独白', '城市'] },
  '心动': { color: '#e89bb0', gradient: 'linear-gradient(90deg, #d4738a, #e89bb0, #f4c2c2)', keywords: ['心跳', '秘密', '期待'] },
  '渴望': { color: '#f4d03f', gradient: 'linear-gradient(90deg, #d4ac0d, #f4d03f, #f7dc6f)', keywords: ['光芒', '闪耀', '丰盛'] },
  '梦想': { color: '#f4d03f', gradient: 'linear-gradient(90deg, #d4ac0d, #f4d03f, #f7dc6f)', keywords: ['天空', '远方', '光芒'] },
  '自由': { color: '#5dade2', gradient: 'linear-gradient(90deg, #2e86c1, #5dade2, #85c1e9)', keywords: ['风', '翅膀', '辽阔'] },
  '沉思': { color: '#5a8aac', gradient: 'linear-gradient(90deg, #2c3e50, #5a8aac, #7fb3d5)', keywords: ['巨物', '时间', '哲学'] },
  '戏谑': { color: '#e8b830', gradient: 'linear-gradient(90deg, #d68910, #e8b830, #f4d03f)', keywords: ['反转', '港风', '漫画'] },
  '遗憾': { color: '#a8c8b5', gradient: 'linear-gradient(90deg, #7fb09a, #a8c8b5, #c8dcc8)', keywords: ['曾经', '转身', '释怀'] },
  '疲惫': { color: '#6b7c93', gradient: 'linear-gradient(90deg, #4a5568, #6b7c93, #95a5a6)', keywords: ['夜色', '灯光', '坚持'] },
  '亲情': { color: '#d4b88a', gradient: 'linear-gradient(90deg, #b8860b, #d4b88a, #e8c89c)', keywords: ['夏日', '家庭', '午后'] },
  '幽默': { color: '#e89bb0', gradient: 'linear-gradient(90deg, #d4738a, #e89bb0, #f4c2c2)', keywords: ['对称', '糖果色', '怪趣'] },
  '回忆': { color: '#a8c8b5', gradient: 'linear-gradient(90deg, #7fb09a, #a8c8b5, #c8dcc8)', keywords: ['岁月', '光影', '温度'] },
  '震撼': { color: '#4fc3f7', gradient: 'linear-gradient(90deg, #0d47a1, #4fc3f7, #81d4fa)', keywords: ['巨物', '冷峻', '史诗'] },
  '童心': { color: '#ffd54f', gradient: 'linear-gradient(90deg, #ffa726, #ffd54f, #fff176)', keywords: ['云朵', '冒险', '纯真'] },
  '释然': { color: '#81c784', gradient: 'linear-gradient(90deg, #66bb6a, #81c784, #a5d6a7)', keywords: ['晨光', '开阔', '平静'] }
};
...
// ========== 生成 AI 影评（豆瓣短评风格） ==========
export function generateReview(_text: string, directorId: string, emotion: string | null): { score: string; review: string } {
  const director = DIRECTORS.find(d => d.id === directorId);
...
export const EMOTION_TO_DNA: Record<string, StyleDNA> = {
  '孤独': { colorTemperature: 'cool', saturation: 'low', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'low-key', scale: 'intimate', pace: 'static', texture: 'grainy' },
  '忧伤': { colorTemperature: 'cool', saturation: 'low', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'low-key', scale: 'intimate', pace: 'static', texture: 'smooth' },
  '思念': { colorTemperature: 'warm', saturation: 'low', contrast: 'medium', compositionType: 'centered', lightingType: 'natural', scale: 'intimate', pace: 'static', texture: 'smooth' },
  '温暖': { colorTemperature: 'warm', saturation: 'medium', contrast: 'low', lightingType: 'natural', scale: 'intimate', pace: 'static', texture: 'smooth', compositionType: 'symmetric' },
  '治愈': { colorTemperature: 'warm', saturation: 'medium', contrast: 'low', compositionType: 'symmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' },
  '震撼': { colorTemperature: 'cool', saturation: 'medium', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'monumental', pace: 'dynamic', texture: 'grainy' },
  '戏谑': { colorTemperature: 'warm', saturation: 'high', contrast: 'high', compositionType: 'asymmetric', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'grainy' },
  '梦想': { colorTemperature: 'cool', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'smooth' },
  '自由': { colorTemperature: 'cool', saturation: 'medium', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'natural', scale: 'monumental', pace: 'dynamic', texture: 'smooth' },
  ...
  '遗憾': { colorTemperature: 'warm', saturation: 'low', contrast: 'medium', compositionType: 'centered', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' },
  '心动': { colorTemperature: 'warm', saturation: 'medium', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'natural', scale: 'intimate', pace: 'dynamic', texture: 'smooth' },
  '渴望': { colorTemperature: 'warm', saturation: 'high', contrast: 'high', compositionType: 'centered', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'smooth' },
  '释然': { colorTemperature: 'warm', saturation: 'medium', contrast: 'low', compositionType: 'symmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' },
  '悲壮': { colorTemperature: 'warm', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'monumental', pace: 'dynamic', texture: 'grainy' },
  '漂泊': { colorTemperature: 'cool', saturation: 'low', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'natural', scale: 'medium', pace: 'dynamic', texture: 'grainy' },
  '怀旧': { colorTemperature: 'warm', saturation: 'low', contrast: 'medium', compositionType: 'asymmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'grainy' },
  '迷茫': { colorTemperature: 'cool', saturation: 'low', contrast: 'low', compositionType: 'asymmetric', lightingType: 'natural', scale: 'medium', pace: 'static', texture: 'smooth' },
  '执念': { colorTemperature: 'cool', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'low-key', scale: 'intimate', pace: 'static', texture: 'grainy' },
  '苦甜': { colorTemperature: 'cool', saturation: 'high', contrast: 'high', compositionType: 'symmetric', lightingType: 'dramatic', scale: 'medium', pace: 'dynamic', texture: 'smooth' },
...
export const EMOTION_VISUAL: Record<string, EmotionVisual> = {
  neutral: { bgColor: ['#d4d4d4', '#c4c4c4', '#b0b0b0'], accentColor: '#9e9e9e', lightness: 0.5, saturation: 0.4, blurRadius: 8, particleCount: 0, particleType: 'none', gradientAngle: 180, vignetteIntensity: 0.25 },
  '孤独': { bgColor: ['#2c3e50', '#3a4a5a', '#4a5568'], accentColor: '#6b7c93', lightness: 0.3, saturation: 0.25, blurRadius: 14, particleCount: 6, particleType: 'fog', gradientAngle: 200, vignetteIntensity: 0.5 },
  '忧伤': { bgColor: ['#34495e', '#465869', '#5d6d7e'], accentColor: '#5d6d7e', lightness: 0.32, saturation: 0.28, blurRadius: 14, particleCount: 40, particleType: 'rain', gradientAngle: 195, vignetteIntensity: 0.5 },
  '思念': { bgColor: ['#b8860b', '#c9a36b', '#d4b88a'], accentColor: '#d4b88a', lightness: 0.5, saturation: 0.45, blurRadius: 10, particleCount: 5, particleType: 'fog', gradientAngle: 180, vignetteIntensity: 0.35 },
  '温暖': { bgColor: ['#d68a5c', '#e8a87c', '#f4c4a0'], accentColor: '#e8a87c', lightness: 0.65, saturation: 0.6, blurRadius: 8, particleCount: 14, particleType: 'sparkle', gradientAngle: 175, vignetteIntensity: 0.2 },
  '治愈': { bgColor: ['#5a9e8a', '#7fc4ab', '#a8d8c8'], accentColor: '#7fc4ab', lightness: 0.6, saturation: 0.5, blurRadius: 9, particleCount: 16, particleType: 'leaf', gradientAngle: 180, vignetteIntensity: 0.22 },
  '暧昧': { bgColor: ['#5b3a6e', '#8e44ad', '#c39bd3'], accentColor: '#c39bd3', lightness: 0.45, saturation: 0.5, blurRadius: 12, particleCount: 8, particleType: 'fog', gradientAngle: 190, vignetteIntensity: 0.4 },
  '心动': { bgColor: ['#d4738a', '#e89bb0', '#f4c2c2'], accentColor: '#e89bb0', lightness: 0.62, saturation: 0.6, blurRadius: 8, particleCount: 18, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.22 },
  '渴望': { bgColor: ['#d4ac0d', '#f4d03f', '#f7dc6f'], accentColor: '#f4d03f', lightness: 0.6, saturation: 0.7, blurRadius: 7, particleCount: 20, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.2 },
  '梦想': { bgColor: ['#6a4c93', '#9b7fd4', '#f4d03f'], accentColor: '#f4d03f', lightness: 0.6, saturation: 0.6, blurRadius: 8, particleCount: 22, particleType: 'star', gradientAngle: 180, vignetteIntensity: 0.25 },
  '自由': { bgColor: ['#2e86c1', '#5dade2', '#85c1e9'], accentColor: '#5dade2', lightness: 0.65, saturation: 0.55, blurRadius: 7, particleCount: 16, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.2 },
  '沉思': { bgColor: ['#2c3e50', '#5a8aac', '#7fb3d5'], accentColor: '#5a8aac', lightness: 0.4, saturation: 0.4, blurRadius: 11, particleCount: 18, particleType: 'star', gradientAngle: 185, vignetteIntensity: 0.4 },
  '戏谑': { bgColor: ['#d68910', '#e8b830', '#f4d03f'], accentColor: '#e8b830', lightness: 0.65, saturation: 0.7, blurRadius: 6, particleCount: 18, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.2 },
  '遗憾': { bgColor: ['#7fb09a', '#a8c8b5', '#c8dcc8'], accentColor: '#a8c8b5', lightness: 0.48, saturation: 0.35, blurRadius: 12, particleCount: 6, particleType: 'fog', gradientAngle: 180, vignetteIntensity: 0.35 },
  '疲惫': { bgColor: ['#4a5568', '#6b7c93', '#95a5a6'], accentColor: '#6b7c93', lightness: 0.35, saturation: 0.25, blurRadius: 13, particleCount: 24, particleType: 'rain', gradientAngle: 195, vignetteIntensity: 0.45 },
  '亲情': { bgColor: ['#b8860b', '#d4b88a', '#e8c89c'], accentColor: '#d4b88a', lightness: 0.6, saturation: 0.5, blurRadius: 9, particleCount: 14, particleType: 'leaf', gradientAngle: 180, vignetteIntensity: 0.22 },
  '幽默': { bgColor: ['#d4738a', '#e89bb0', '#f4c2c2'], accentColor: '#e89bb0', lightness: 0.65, saturation: 0.6, blurRadius: 7, particleCount: 18, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.2 },
  '回忆': { bgColor: ['#7fb09a', '#a8c8b5', '#c8dcc8'], accentColor: '#a8c8b5', lightness: 0.5, saturation: 0.35, blurRadius: 12, particleCount: 8, particleType: 'fog', gradientAngle: 180, vignetteIntensity: 0.32 },
  '震撼': { bgColor: ['#0d47a1', '#4fc3f7', '#81d4fa'], accentColor: '#4fc3f7', lightness: 0.45, saturation: 0.5, blurRadius: 10, particleCount: 24, particleType: 'star', gradientAngle: 180, vignetteIntensity: 0.4 },
  '童心': { bgColor: ['#ffa726', '#ffd54f', '#fff176'], accentColor: '#ffd54f', lightness: 0.7, saturation: 0.7, blurRadius: 6, particleCount: 22, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.18 },
  '释然': { bgColor: ['#66bb6a', '#81c784', '#a5d6a7'], accentColor: '#81c784', lightness: 0.62, saturation: 0.5, blurRadius: 8, particleCount: 16, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.2 },
  '悲壮': { bgColor: ['#641e16', '#c0392b', '#1a1a1a'], accentColor: '#f1c40f', lightness: 0.35, saturation: 0.6, blurRadius: 11, particleCount: 30, particleType: 'rain', gradientAngle: 200, vignetteIntensity: 0.5 },
  '漂泊': { bgColor: ['#4a5568', '#7a7a6e', '#95a5a6'], accentColor: '#a89060', lightness: 0.4, saturation: 0.3, blurRadius: 13, particleCount: 8, particleType: 'fog', gradientAngle: 190, vignetteIntensity: 0.4 },
  '怀旧': { bgColor: ['#7a6a48', '#a89060', '#d5c8a8'], accentColor: '#a89060', lightness: 0.45, saturation: 0.35, blurRadius: 12, particleCount: 10, particleType: 'fog', gradientAngle: 180, vignetteIntensity: 0.35 },
  '迷茫': { bgColor: ['#5a5a6a', '#7a7a8a', '#9aa0aa'], accentColor: '#7a7a8a', lightness: 0.4, saturation: 0.25, blurRadius: 14, particleCount: 8, particleType: 'fog', gradientAngle: 185, vignetteIntensity: 0.42 },
  '执念': { bgColor: ['#1a1a2e', '#2c2c4e', '#4a3060'], accentColor: '#8e44ad', lightness: 0.3, saturation: 0.5, blurRadius: 12, particleCount: 16, particleType: 'star', gradientAngle: 200, vignetteIntensity: 0.5 },
  '苦甜': { bgColor: ['#3d2a5a', '#6a4c93', '#ff6b35'], accentColor: '#ffd23f', lightness: 0.5, saturation: 0.6, blurRadius: 9, particleCount: 18, particleType: 'sparkle', gradientAngle: 180, vignetteIntensity: 0.35 }
};
...
const _DARK_KEYWORDS = ['黑', '暗', '夜', '阴影', '死', '哭', '痛', '孤独', '悲', '伤', '泪', '离', '失', '空', '碎', '寒'];
...
export function analyzeTextMood(text: string): TextMood {
  ...
  let warm = 0, cold = 0, energy = 0, calm = 0, dark = 0, light = 0;
  _WARM_KEYWORDS.forEach(k => { if (text.includes(k)) warm++; });
  _COLD_KEYWORDS.forEach(k => { if (text.includes(k)) cold++; });
  _ENERGY_KEYWORDS.forEach(k => { if (text.includes(k)) energy++; });
  _CALM_KEYWORDS.forEach(k => { if (text.includes(k)) calm++; });
  _DARK_KEYWORDS.forEach(k => { if (text.includes(k)) dark++; });
  _LIGHT_KEYWORDS.forEach(k => { if (text.includes(k)) light++; });
